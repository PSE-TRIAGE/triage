...
describe("AdminUsersServiceImpl", () => {
	...
	it("createUser calls post", async () => {
		...
		expect(apiClient.post).toHaveBeenCalledWith("/admin/users", expect.any(Object), { username: "test", password: "pass" });
	});
	...
	it("deleteUser calls delete with user id", async () => {
		...
		expect(apiClient.delete).toHaveBeenCalledWith("/admin/users/5", expect.any(Object));
	});
	...
	it("disableUser calls patch", async () => {
		...
		expect(apiClient.patch).toHaveBeenCalledWith("/admin/users/3/disable", expect.any(Object));
	});
	...
	it("enableUser calls patch", async () => {
		...
		expect(apiClient.patch).toHaveBeenCalledWith("/admin/users/3/enable", expect.any(Object));
	});
	...
	it("promoteUser calls patch", async () => {
		...
		expect(apiClient.patch).toHaveBeenCalledWith("/admin/users/promote/2", expect.any(Object));
	});
	...
	it("demoteUser calls patch", async () => {
		...
		expect(apiClient.patch).toHaveBeenCalledWith("/admin/users/demote/2", expect.any(Object));
	});
	...
	it("listUserProjects calls get", async () => {
		...
		expect(apiClient.get).toHaveBeenCalledWith("/admin/users/4/projects", expect.any(Object));
	});
});
