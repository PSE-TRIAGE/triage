...
describe("LoadingButton", () => {
	...
	it("is disabled when loading", () => {
		render(<LoadingButton loading loadingText="Loading...">Submit</LoadingButton>);
	...
	it("renders icon when not loading", () => {
		render(<LoadingButton icon={<span data-testid="icon">🚀</span>}>Submit</LoadingButton>);
		expect(screen.getByTestId("icon")).toBeInTheDocument();
	});

	it("hides icon when loading", () => {
		render(
			<LoadingButton loading loadingText="Loading..." icon={<span data-testid="icon">🚀</span>}>
				Submit
			</LoadingButton>,
		);
