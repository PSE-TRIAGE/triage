...
describe("Tabs", () => {
	...
	it("applies custom className", () => {
		render(
			<Tabs defaultValue="a" className="custom" data-testid="tabs">
				<TabsList className="list-cls" data-testid="list">
					<TabsTrigger value="a" className="trig-cls" data-testid="trigger">
						A
					</TabsTrigger>
				</TabsList>
				<TabsContent value="a" className="content-cls" data-testid="content">
					C
				</TabsContent>
			</Tabs>,
		);
		...
		expect(screen.getByTestId("content").className).toContain("content-cls");
	});
});
