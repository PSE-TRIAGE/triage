...
describe("CreateProjectModal", () => {
	...
	it("renders dialog description", () => {
		...
		expect(screen.getByText(/Set up a new mutation testing project/)).toBeInTheDocument();
	});
	...
	it("renders project name placeholder", () => {
		...
		expect(screen.getByPlaceholderText("e.g., Team 1 - Calculator")).toBeInTheDocument();
	});
	...
	it("renders optional description for source code", () => {
		...
		expect(screen.getByText("Optional: Upload project source code")).toBeInTheDocument();
	});
});
